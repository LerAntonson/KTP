public class lab1 {
	public static void main (String[] args)
	{
		...
		if (checkPoints(myPoint[0], myPoint[1], myPoint[2])) //Проверочка на совпадение (равность) точек
			...
			System.out.println("The points are equal, enter the correct coordinates of the points");
		}
	...
	public static boolean checkPoints(Point3d p1, Point3d p2, Point3d p3) // Проверка совпадения/равности точек
	{
